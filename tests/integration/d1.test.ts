...
const profile: UserProfile = { username: 'CaseUser', canonicalUsername: 'CaseUser', profileUrl: 'https://myanimelist.net/profile/CaseUser', avatarUrl: null, about: null, gender: null, location: null, birthday: null, joinedAt: null, lastOnlineAt: null, fetchedAt };
...
function entry(id: number, type: 'anime' | 'manga' = 'anime'): UserMediaListEntry { return { username: 'caseuser', mediaType: type, malId: id, title: `Title ${id}`, imageUrl: null, status: null, score: null, progress: null, total: null, startedAt: null, finishedAt: null, updatedAt: null, fetchedAt }; }
