...
`f2b389cd`, `086145f9`, `2139e894`, `9679c755`, `44d028aa`, `0523faba`, `b9cf7782`, `f7d1a163`. The
deploy publishing this filled-in line is not named — an entry can never name the version that ships
it, the same structural gap as the 2026-08-16 section.

Of those, five carried the changes below: `629508ce` raised the size ceiling to 5 MiB, recovering
...
fix, and `f7d1a163` the seasonal media type. The rest are documentation and a line-ending
